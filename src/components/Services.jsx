          ...
          <Fade>
            <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
              ...
              <p className="max-w-[40rem] text-md mx-auto mt-4 text-gray-500">
                Guru Nanak Dentals provide a comprehensive suite of dental
                services including General, Cosmetic, Restorative, Pediatric and
                Emergency Dentistry.
              </p>
            </div>
          </Fade>
        ...
        <ul className="grid gap-4 h-30 mt-6 sm:grid-cols-2   lg:grid-cols-4 ">
          <Fade>
            <li className="bg-slate-200 rounded-md">
              <img src={Service1} alt="" className="rounded-md" />
          ...
          <Fade>
            <li className="bg-slate-200 rounded-md">
              <img src={Xray} alt="" className="rounded-md" />
          ...
          <Fade>
            <li className="bg-slate-200 rounded-md">
              <img src={Ortho} alt="" className="rounded-md" />
          ...
          <Fade>
            <li className="bg-slate-200  rounded-md">
              <img src={Bridge} alt="" className="rounded-md" />
          ...
          <Fade>
            <li className="bg-slate-200 rounded-md">
              <img src={Toothache} alt="" className="rounded-md" />
          ...
          <Fade>
            <li className="bg-slate-200 rounded-md">
              <img src={Extraction} alt="" className="rounded-md" />
          ...
          <Fade>
            <li className="bg-slate-200 rounded-md">
              <img src={RootCanal} alt="" className="rounded-md" />
          ...
          <Fade>
            <li className="bg-slate-200 rounded-md">
              <img src={Consultation} alt="" className="rounded-md" />{" "}
              <div className="relative py-2">
                <h3 className="text-m text-center text-gray-700 group-hover:underline group-hover:underline-offset-4">
